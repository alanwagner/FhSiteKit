...
namespace SilPatternTest\Controller;

use SilPattern\Model\Pattern;
use SilPatternTest\Bootstrap;
...
class PatternTest extends AbstractHttpControllerTestCase
{
    ...
    {
        $patternTableMock = $this->getMockBuilder('SilPattern\Model\PatternTable')
        ...
        $this->assertModuleName('SilPattern');
